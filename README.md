...
**Additionally you can access  ```https://<YOUR_SERVERS_IP>:<PORT>/todos``` to see all todos in the database or ```https://<YOUR_SERVERS_IP>:<PORT>/todos/<ID>``` to look for a specific ID*
